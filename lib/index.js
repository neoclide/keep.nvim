...
let TestPlugin = (_dec = (0, _neovim.Plugin)({ dev: !!process.env.NVIM_NODE_HOST_DEBUG }), _dec2 = (0, _neovim.Autocmd)('VimEnter', {
  sync: false,
  pattern: '*'
}), _dec3 = (0, _neovim.Autocmd)('VimLeave', {
  sync: false,
  pattern: '*'
  ...
  pattern: '*',
  eval: 'expand("<afile>:p")'
}), _dec5 = (0, _neovim.Command)('KeepRestore', {
  sync: true,
  nargs: '*'
}), _dec6 = (0, _neovim.Function)('KeepRemovedFiles', { sync: true }), _dec(_class = (_class2 = class TestPlugin {
  async onVimEnter() {
  ...
  async removedFiles(args) {
    if (!redisClient) return [];
    let root = args.length == 0 ? await this.nvim.eval('getcwd()') : args[0];
...
}, (_applyDecoratedDescriptor(_class2.prototype, 'onVimEnter', [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, 'onVimEnter'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'onVimLeave', [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, 'onVimLeave'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'onBufWrite', [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, 'onBufWrite'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'keepRestore', [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, 'keepRestore'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'removedFiles', [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, 'removedFiles'), _class2.prototype)), _class2)) || _class);
